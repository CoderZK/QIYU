...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.dataArray[indexPath.row] isKindOfClass:[UIImage class]]) {
        ...
        [cell.imageView sd_setImageWithURL:[NSURL URLWithString: [QQYYURLDefineTool getImgURLWithStr:[NSString stringWithFormat:@"%@",self.dataArray[indexPath.row]]]] placeholderImage:[UIImage imageNamed:@"zk_morenfang"]];
